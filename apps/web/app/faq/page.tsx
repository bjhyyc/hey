    ...
    <PageShell compact>
      ...
      <div className="support-card faq-card">
        ...
        <section className="support-block" id="time">
          <h2>要等多久？中间需要我做什么？</h2>
          <p>
            全程约 <strong>20 分钟</strong>。付款后先生成正面和侧面两张形象图，
            这一步需要你回到项目页<strong>确认形象</strong>；确认后其余动作全部自动生成，页面会自己刷新，关掉稍后回来也不会丢进度。
          </p>
        </section>
        ...
        <section className="support-block" id="likeness">
          <h2>形象不像怎么办？</h2>
          <p>
            AI 是依据照片重新绘制，会尽量贴近，但不是照片复刻。确认页上正面、侧面两张各可<strong>免费重新生成 2 次</strong>，
            单独重做不满意的那张即可。确认之后所有动作都按这个形象生成，中途不能再换，所以请在确认前挑到满意为止。
          </p>
        </section>
