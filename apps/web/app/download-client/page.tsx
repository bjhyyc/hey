...
export default function DownloadClientPage() { return <PageShell compact>
  <PageIntro eyebrow="客户端" title="桌宠客户端">安装后导入 PetPack 即可使用。</PageIntro>
  <section className="download-card">
    ...
    <button className="primary-button form-submit" disabled type="button">客户端安装包准备后提供下载</button></div>
  </section>
</PageShell>; }
