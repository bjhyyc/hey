  ...
  return (
    <PageShell compact>
      ...
      <article className="legal-copy">
        ...
        <h2>我们如何使用这些信息</h2>
        <p>
          仅用于三件事：为你生成并交付素材包、处理售后与退款、保障服务安全。
        ...
        <ul>
          ...
          <li>为保证售后与重新下载，你的照片、生成的形象与动作素材、以及素材包在交付后至少保留 30 天。</li>
        ...
        <p>
          ...
          请通过<a href="/support">联系客服</a>页面按指引联系我们（{contact}），并提供项目页底部的<strong>项目编号</strong>（这是我们在不保存手机号的前提下定位你的唯一方式）。
